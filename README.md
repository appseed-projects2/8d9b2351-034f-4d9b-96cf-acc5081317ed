...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-13 20:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8d9b2351-034f-4d9b-96cf-acc5081317ed.git
$ cd 8d9b2351-034f-4d9b-96cf-acc5081317ed
```
